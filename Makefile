...
lint-py:  ## lint python with ruff
	python -m ruff check hatch_build
	python -m ruff format --check hatch_build
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix hatch_build
	python -m ruff format hatch_build
...
test:  ## run python tests
	python -m pytest -v hatch_build/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v hatch_build/tests --cov=hatch_build --cov-report term-missing --cov-report xml
